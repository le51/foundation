            ...
            <form action="/phalcon/foundation/contact/send" method="post" data-abide id="contactForm">
              <div class="row collapse">
                ...
                <div class="large-10 columns">
                  <?php echo Phalcon\Tag::textField(array('id' => 'name', 'placeholder' => 'Enter your name', 'required pattern' => '[a-zA-Z]+')); ?>
              ...
              <?php echo Phalcon\Tag::textArea(array('id' => 'content', 'value' => 'content', 'placeholder' => 'Your message', 'rows' => '4')); ?>
